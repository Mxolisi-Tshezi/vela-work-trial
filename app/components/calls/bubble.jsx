...
//   translation,
//   speaker,
//   sentiment = "neutral", // Default value to prevent errors
//   language,
//   timestamp,
//   showTranslation,
//   onClick,
...
//   // Ensure we have valid props or defaults
//   const safeTimestamp = timestamp || 0;
//   const safeSpeaker = speaker || "unknown";
...
//   let textToShow = "";
//   try {
//     if (!language || !["en-za", "english"].includes(language.toLowerCase())) {
//       textToShow = showTranslation ? (translation || text || "") : (text || "");
//     } else {
//       textToShow = text || "";
//     }
//   } catch (error) {
//     console.error("Error determining text to show:", error);
//     textToShow = text || "";
//   }

//   return textToShow.trim() !== "" ? (
//     <div
//       id={`stamp-${safeTimestamp}`}
//       className="flex !overflow-x-visible text-sm"
//     >
//       <div
//         className={`${
//           safeSpeaker === "agent" || safeSpeaker === "bot" ? "agent" : "customer"
//         } relative my-4 !overflow-x-visible`}
//         onClick={onClick}
//       >
//         <p className="title text-vela-text-color absolute -top-5 text-xs">
...
//         </p>
//         <p className="absolute text-vela-text-color -top-5 right-1 text-xs">
//           {safeTimestamp instanceof Date
//             ? moment(safeTimestamp).format("DD/MM/YYYY, HH:mm")
//             : toTimeString(safeTimestamp)}
//         </p>
//         <p 
//           ref={speechRef}
//           className="!py-0.5 !px-2 !m-0 !text-sm"
//         >
//           {textToShow}
//         </p>
//         <div
//           className={`absolute -bottom-2 ${
//             safeSpeaker === "agent" ? "left-1.5" : "right-2"
//           } text-black font-bold rounded-full floating max-w-fit p-0.5 ${
//             colours[safeSentiment]
//           }`}
//         >
//           {icons[safeSentiment]}
//         </div>
